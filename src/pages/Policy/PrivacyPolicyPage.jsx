    ...
    <Wrapper>
      ...
      <Container className>
        ...
        <List>
          ...
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
            <span>قد يتم النظر في إعادة الأموال في حال إلغاء أو تأجيل المادة أو خصم المبلغ مرتين بالخطأ.</span>
          </ListItem>
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
          ...
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
            <span>لا يتم استرجاع الأموال بسبب عدم ملاءمة العتاد التقني أو حذف المواد التعليمية لأسباب قانونية.</span>
          </ListItem>
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
          ...
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
            <span>لا يحق للمستخدم طلب استرجاع المبلغ إذا لم يجتاز المادة.</span>
          </ListItem>
        </List>
        ...
        <p>
          الشهادات
          تُصدر منصة سيان والمؤسسات المقدمة للمواد التعليمية شهادات إتمام بناءً على تقديرها الخاص، وقد لا تُمنح شهادة لبعض المواد التعليمية وفقًا لمعاييرها.
          لا يتيح التسجيل أو إكمال المواد التعليمية على سيان التقدم لبرامج درجات أكاديمية في المؤسسات المقدمة لها.
          استخدام موارد المادة يقتصر على نطاق المنصة فقط، ولا يمنح أي امتيازات إضافية للمستخدم.
        </p>
        ...
        <List>
          ...
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
            <span>يمنع التلاعب بالأسعار أو التدخل في قوائم المواد التعليمية.</span>
          </ListItem>
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
          ...
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
            <span>لا يجوز الوصول غير القانوني لأنظمة المنصة أو إعادة تفعيل حساب تم إيقافه.</span>
          </ListItem>
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
        ...
        <List>
          <ListItem>
            ...
            عند استئجار المادة التعليمية، فإنك تحصل على حق الوصول المؤقت إلى محتواها، ويُعتبر هذا الاستئجار ساريًا حتى انتهاء المدة المحددة أو في حال توقف المنصة أو تعطلها نهائيًا.
            أنت توافق على دفع رسوم استئجار المادة التعليمية، وتفوضنا بمعالجة المدفوعات عبر بطاقات الخصم/الائتمان أو أي وسيلة دفع أخرى بالتعاون مع شركائنا من مزودي خدمات الدفع.</span>
          </ListItem>
          <ListItem>
            <IconWrapper><FaCheckCircle /></IconWrapper>
        ...
        <p>
          ...
          قد نرسل تحديثات عن الخدمات الجديدة أو المواد التعليمية عبر البريد الإلكتروني، مع إمكانية إلغاء الاشتراك في أي وقت.
        ...
        <p>
          ...
          منصة سيان وجميع الشركات والأطراف المرتبطة بها تقدم خدماتها "كما هي" دون أي ضمانات صريحة أو ضمنية، بما في ذلك ضمانات النتائج المرجوة من المواد التعليمية. استخدامك للخدمات يكون على مسؤوليتك الخاصة، ولا تتحمل المنصة أي مسؤولية عن مصداقية الأعضاء أو المحتوى.
        </p>
