        ...
        {toolType === TOOL_TYPES.FLIPPING && (
          <div>
            ...
            >
              ...
              <div>
                <strong>⚠️ ملاحظة مهمة:</strong> أقصى حجم للصور في الأدوات التفاعلية هو <strong>2 ميجابايت فقط</strong>
              </div>
            </div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                // التحقق من حجم الملف قبل تحديد القيمة
                if (file) {
                  const maxSize = 2 * 1024 * 1024; // 2MB
                  if (file.size > maxSize) {
                    const sizeInMB = (file.size / (1024 * 1024)).toFixed(2);
                    error(`حجم الصورة كبير جداً (${sizeInMB} ميجا). الحد الأقصى المسموح للأدوات التفاعلية هو 2 ميجابايت فقط.`);
                    e.target.value = ''; // إعادة تعيين حقل الاختيار
                    return;
                  }
                }
              ...
              style={{ 
                width: '100%', 
                padding: '12px 14px', 
                border: `2px solid ${cardFormik.touched.image && cardFormik.errors.image ? '#ef4444' : '#e2e8f0'}`, 
                borderRadius: '8px', 
                fontSize: '14px', 
            ...
            <p style={{ fontSize: '11px', color: '#64748b', marginTop: '4px' }}>
              {editingCard && cardFormik.values.image && typeof cardFormik.values.image === 'string' 
                ? 'اختر صورة جديدة لاستبدال الصورة الحالية (اختياري) - حد أقصى 2MB' 
                : 'اختر صورة للبطاقة - حد أقصى 2 ميجابايت'
              }
            </p>
