...
/**
 * مكون إضافة اختبار جديد للدرس
 * 
 * يتيح للمستخدم إنشاء اختبار جديد للدرس المحدد في الدورة التدريبية
 * مع إمكانية إضافة أسئلة متعددة بأنواع مختلفة (اختيار من متعدد، صح/خطأ، إجابة واحدة)
 * ويقوم بإرسال البيانات إلى الخادم عبر API
 * 
 * يتطلب وجود درس محدد مسبقاً ويتكون من خطوتين:
 * 1. إدخال معلومات الاختبار الأساسية (العنوان)
