  ...
  chapters: [
    {
      ...
      lessons: [
        { id: "lesson1a", type: "video", title: "درس تقديمي", video: { title: "مقدمة الدورة" } },
  ...
  const sidebarButtons = [
    {
      id: "course-info",
      icon: <FiSettings />,
      label: "معلومات الدورة",
      description: "تعديل بيانات الدورة الأساسية",
      color: "#0062ff"
    },
    {
      id: "curriculum", 
      icon: <FiBook />,
      label: "المقرر",
      description: "إدارة فصول ودروس الدورة",
      color: "#29e088"
    }
  ];
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <h5 style={{ margin: 0, color: '#1a202c', fontWeight: 'bold', fontSize: '20px' }}>
                    {activeSection === "course-info" ? "معلومات الدورة التدريبية" : "فصول ودروس الدورة"}
                  </h5>
            ...
            <div style={{ 
              ...
              {activeSection === "course-info" && (
                <div style={{ textAlign: 'center', padding: '60px 20px', color: '#718096' }}>
                  ...
                  <h5 style={{ color: '#0062ff', marginBottom: '12px' }}>معلومات الدورة التدريبية</h5>
                  <p style={{ marginBottom: '24px' }}>
                    سيتم عرض نموذج تعديل معلومات الدورة هنا قريباً.
                  </p>
                  <button className="btn btn-primary" onClick={() => toast.info("نموذج معلومات الدورة قيد التطوير")}>
                    <FiEdit style={{ marginRight: '8px' }} />
                    تعديل معلومات الدورة (قيد الإنشاء)
                  </button>
                </div>
              )}
