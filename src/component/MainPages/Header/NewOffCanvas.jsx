...
const NewOffCanvas = ({ show, onClose, logo, links, renderUserButtons }) => {
   ...
   {show && (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-4">
        <h5 id="drawer-right-label" className="inline-flex items-center text-base font-semibold text-gray-500 ">
          <div className="logo">
          ...
          <li key={index}>
            <a
              ...
              className={`block py-2 ps-3 hover:bg-gray-100  ${
                location.pathname === link.path ? classes.NavActive + " bg-zinc-100 rounded-md" : ""
              }`}
      ...
      {/* User Buttons */}
      <div className="flex mt-10 gap-4 px-4">{renderUserButtons()}</div>
    </div>
