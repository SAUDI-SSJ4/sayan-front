...
const FaqTraining = () => {
  ...
  const data = [
    {
      title: "هل يمكن متابعة تقدم الموظفين داخل البرنامج التدريبي؟",
    ...
    {
      title: "كيف يمكن للشركات استخدام منصة سيان لتدريب موظفيها؟",
      content: "نعم، عبر إنشاء أكاديمية خاصة بالشركة وتصميم برامج تدريبية مخصصة.",
    },
    {
      title: "هل تقدم سيان الدعم الفني في تدريب الموظفين؟",
      content: "نعم، منصة سيان تقدم عدة خدمات مثل إنشاء المحتوى التعليمي، المتابعة مع المتدربين، وإرسال تقارير دورية بالتقدم.",
    }
  ];
