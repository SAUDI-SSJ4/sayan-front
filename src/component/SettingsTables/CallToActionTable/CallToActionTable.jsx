...
import { useAllActions } from "../../../framework/accademy/academysetting-calltoaction";
    ...
    <Cell {...props} className="link-group">
      <div style={{ color: "#A3AED0" }}>
        <BorderColorOutlinedIcon
          sx={{ cursor: "pointer" }}
          onClick={() => navigate(`/academy/settings/call-to-action/edit/${rowData[dataKey]}`)}
        />
      </div>
    </Cell>
  );
...
const CallToActionTable = ({
  ...
  let { data: faqData, isLoading, errors } = useAllActions();
...
export default CallToActionTable;
