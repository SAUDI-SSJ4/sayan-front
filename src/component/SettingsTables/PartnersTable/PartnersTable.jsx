...
import { usePartner } from "../../../framework/accademy/academysetting-partner";
...
const StatusCell = ({ rowData, dataKey, ...props }) => {
  return (
    <Cell {...props}>
      {rowData[dataKey]==1?"مفعل":"غير مفعل"}
    </Cell>
  );
};
    ...
    <Cell {...props} className="link-group">
      <div style={{color: "#A3AED0" }}>
        <BorderColorOutlinedIcon
          sx={{ cursor: "pointer" }}
          onClick={() => navigate("/academy/settings/partner/edit")}
        />
...
console.log(checkedKeys);
  ...
  let{data:faqData,isLoading,errors}= usePartner()
      ...
      <div style={{ overflowX: "auto" }} className="mt-2">
        ...
        >
          ...
          <Column  minWidth={150}>
            ...
            dataKey="id" setShow={setDeleteModal} />
          </Column>
        </Table>
      </div>
    </div>
