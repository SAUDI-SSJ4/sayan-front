...
import { useTemplate } from "../../../framework/accademy/academysetting-template";
    ...
    <Cell {...props} className="link-group">
      <div style={{ color: "#A3AED0" }}>
        <BorderColorOutlinedIcon
          sx={{ cursor: "pointer" }}
          onClick={() => navigate("/academy/settings/call-to-action/edit")}
        />
...
const TemplateTable = ({
  ...
  let { data: faqData, isLoading, errors } = useTemplate();
